...
const Navbar = () => {
    return (
        <nav className='bg-purple-300 flex justify-around p-5 items-center shadow-lg'>
            <div className="logo font-bold text-2xl">
                <span className='text-purple-600'>&lt;</span>
                Safe
                <span className='text-purple-600'>IT/&gt;</span>
            </div>
            <a href="https://github.com/Sagardharaglkar" target='_blank'>
                <button className='hover:bg-purple-400 flex gap-2 px-3 py-1 border-2 rounded-full border-purple-500 '>
